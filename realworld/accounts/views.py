...
def settings(request: HttpRequest) -> HttpResponse:
    ...
    return TemplateResponse(
        request, "realworld/accounts/partials/_settings.html", {"form": form}
    )
...
def register(request: HttpRequest) -> HttpResponse:
    ...
    if request.method == "GET":
        return TemplateResponse(
            request,
            "realworld/registration/register.html",
    ...
    if (form := UserCreationForm(request.POST)).is_valid():
        ...
        return HttpResponseClientRedirect(reverse("realworld:articleshome"))

    return TemplateResponse(
        request, "realworld/registration/partials/_register.html", {"form": form}
    )
...
def follow(request: HttpRequest, user_id: int) -> HttpResponse:
    ...
    return TemplateResponse(
        request,
        "realworld/accounts/partials/_follow_action.html",
        {
            "followed": user,
